...
#define NL_END_AMBIENT vec3(3.0,2.7,2.15)

/* Sun/moon light color on terrain */
#define NL_MORNING_SUN_COL vec3(1.0,0.5,0.12)
#define NL_NOON_SUN_COL    vec3(1.0,0.6,0.3)
#define NL_NIGHT_SUN_COL vec3(0.0,0.0,0.085)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.0,0.45,0.0)
#define NL_UNDERWATER_TORCH_COL vec3(1.0,0.45,0.0)
#define NL_NETHER_TORCH_COL     vec3(1.0,0.45,0.0)
#define NL_END_TORCH_COL        vec3(1.0,0.45,0.0)

/* Fog */
#define NL_FOG_TYPE 2             // 0:no fog, 1:vanilla, 2:smoother vanilla
#define NL_MIST_DENSITY 0.64      // 0.0 no mist ~ 1.0 misty
#define NL_RAIN_MIST_OPACITY 0.5 // [toggle] 0.04 very subtle ~ 0.5 thick rain mist blow

/* Sky colors - zenith=top, horizon=bottom */
#define NL_DAY_ZENITH_COL    vec3(0.0, 0.1, 0.2)
#define NL_DAY_HORIZON_COL   vec3(0.25, 0.35, 0.46)
#define NL_NIGHT_ZENITH_COL  vec3(0.007, 0.012, 0.016)
#define NL_NIGHT_HORIZON_COL vec3(0.0, 0.05, 0.16)
#define NL_RAIN_ZENITH_COL   vec3(0.22,0.22,0.22)
#define NL_RAIN_HORIZON_COL  vec3(0.6,0.5,0.4)
#define NL_END_ZENITH_COL    vec3(0.0, 0.0, 0.0)
#define NL_END_HORIZON_COL   vec3(1.0,0.9,0.8)
#define NL_DAWN_ZENITH_COL   vec3(0.015,0.045,0.1)
#define NL_DAWN_HORIZON_COL  vec3(1.0,0.55,0.1)
#define NL_DAWN_EDGE_COL     vec3(1.0,0.65,0.1)
...
/* Water */
#define NL_WATER_TRANSPARENCY 0.1 // 0.0 transparent ~ 1.0 normal
...
#define NL_WATER_TINT vec3(0.87,0.9,1.0)
...
/* Soft cloud settings */
#define NL_CLOUD1_SCALE vec2(0.01, 0.01) // 0.003 large ~ 0.2 tiny
...
#define NL_AURORA_COL2 vec3(0.0,0.3,1.0)
...
/* Clouds Color */
#define NL_CLOUD2_NIGHT_COL vec3(0.1)
#define NL_CLOUD2_DAWN_COL vec3(0.5)
...
#ifdef DEFAULT_CLOUDS_MULTILAYER
#define NL_CLOUD2_MULTILAYER 
#endif

#ifdef VOLUMETRIC_CLOUD2
